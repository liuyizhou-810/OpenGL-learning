...
int threeD4()
{
    ...
    glm::mat4 projection = glm::mat4(1.0f);
    projection = glm::perspective(glm::radians(50.0f), screenWidth / screenHeight, 0.1f, 100.0f);
...
int threeD5()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model2 = glm::rotate(model2, (float)glfwGetTime() * glm::radians(50.0f), glm::vec3(0.5f, 1.0f, 0.0f));
